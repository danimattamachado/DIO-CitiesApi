...
import lombok.Data;
import utils.StringLocationUtils;
...
public class DistanceService {
	...
	@Autowired
	  ...
	  public Double distanceUsingMath(final Long city1, final Long city2, final EarthRadius unit) {
	    ...
	    final List<City> cities = repoCity.findAllById((Arrays.asList(city1, city2)));
	  ...
	  public Double distanceByPointsInMiles(final Long city1, final Long city2) {
	    ...
	    return repoCity.distanceByPoints(city1, city2);
	  }
	  ...
	  public Double distanceByCubeInMeters(Long city1, Long city2) {
	    ...
	    return repoCity.distanceByCube(p1.getX(), p1.getY(), p2.getX(), p2.getY());
	  }
